...
namespace Dapper
{
    ...
    public static class SqlHelper
    {
        ...
        public static string GetConnectionString(string connectionString = null)
        {
            ...
            {//return Convert.ToString(EncryptDecrypt.DecryptValue(ConfigurationManager.AppSettings["DBConnString"]));
                return Convert.ToString(ConfigurationManager.AppSettings["DBConnString"]);
            }
            else
